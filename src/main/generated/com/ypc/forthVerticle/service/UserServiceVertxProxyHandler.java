...
public class UserServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        case "selectUserById": {
          service.selectUserById(json.getValue("id") == null ? null : (json.getLong("id").intValue()), createHandler(msg));
          break;
        }
        case "selectUserConditional": {
          service.selectUserConditional((java.lang.String)json.getValue("address"), json.getValue("age") == null ? null : (json.getLong("age").intValue()), createListHandler(msg));
          break;
        }
